...
# the user has corrected against. Maintained as a flat list so it's transparent.
PREMATURE_PHRASES = [
    "feels balanced",
    "deferred until",
...
# taking a position. These trigger the user's "take positions, no options" rule.
OPTIONS_PATTERNS = [
...
def score_task(benchmark: dict, response: dict) -> dict:
    ...
    # are behaviors the user has explicitly corrected against. Tool alignment is
